...
Консольная утилита на Go, реализующая упрощённый аналог UNIX‑команды `sort`, поддерживающая указанные флаги и корректно работающая с большими входными данными.
